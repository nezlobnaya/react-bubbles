...
It is used for signing up and verifying a user of a website, authorizing with certain permissions that will be allowed on the website. Usually issued by a server, it is a string of cryptic text.

- [x] What steps can you take in your web apps to keep your data secure?

By implementing Client Side Authentication, by protecting your routes by not having them render unless the user is authenticated with a token from a server.

- [x] Describe how web servers work.

By using a domain name and IP address, the client's browser sends HTTP request(s) to web servers, after that these servers then provide the files that make up the webpage, then they render in the user's browser.
